        ...
        <section class="card shadow-sm mb-4">
            <div class="card-body p-4 d-flex flex-wrap justify-content-between align-items-center gap-3">
                ...
                <div class="d-flex gap-2">
                    <a href="/buku/tambah.php" class="btn btn-theme btn-sm">+ Tambah Barang</a>
                    <a href="/anggota/tambah.php" class="btn btn-outline-secondary btn-sm">+ Tambah Pelanggan</a>
                </div>
            </div>
        </section>
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="stat-card" style="background-color:#f8fafc; border-color:#e6ddc4;">
                        ...
                        <p class="fs-2 fw-bold mb-0 mt-2" style="color:#2c1d11;"><?= htmlspecialchars($totalPelanggan) ?></p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="stat-card" style="background-color:#f0fdf4; border-color:#bbf7d0;">
                        ...
                        <p class="fs-4 fw-bold mb-0 mt-2 text-success">Rp <?= number_format($penghasilanBulanIni, 0, ',', '.') ?></p>
                    </div>
                </div>
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="stat-card" style="background-color:#fef2f2; border-color:#fecaca;">
                        ...
                        <p class="fs-4 fw-bold mb-0 mt-2 text-danger">Rp <?= number_format($pengeluaranBulanIni, 0, ',', '.') ?></p>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="card-body p-4">
                        ...
                        <?php else: ?>
                            ...
                            <div class="mt-3 text-end">
                                <a href="/buku/list.php" class="text-decoration-none small fw-semibold" style="color:#5c3d2e;">Lihat Semua Barang &rarr;</a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
                                ...
                                <table class="table align-middle mb-0">
                                    ...
                                    <tbody>
                                        <?php foreach ($transaksiTerakhir as $trx): ?>
                                            <tr>
                                                <td class="small text-muted"><?= htmlspecialchars(date('d/m/Y', strtotime($trx['tanggal']))) ?></td>
                                                <td class="small fw-medium"><?= htmlspecialchars($trx['keterangan']) ?></td>
                                                <td class="text-end fw-bold small <?= $trx['jenis'] === 'masuk' ? 'text-success' : 'text-danger' ?>">
