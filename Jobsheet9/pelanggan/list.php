            ...
            <div class="table-responsive mt-3">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4">Belum ada data pelanggan. Silakan tambah
                                pelanggan baru.</td>
                        </tr>
                        <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-sm btn-success me-1" data-bs-toggle="modal"
                                    data-bs-target="#modalBeli<?= $pelanggan['id'] ?>">
                                    + Beli Barang
                                </button>
                                <a href="/Jobsheet9/pelanggan/edit.php?id=<?= $pelanggan['id'] ?>"
                                    class="btn btn-sm btn-outline-warning me-1">
                                    Edit
                                </a>
                                <a href="/Jobsheet9/pelanggan/hapus.php?id=<?= $pelanggan['id'] ?>"
                                ...
                                <div class="modal fade text-start" id="modalBeli<?= $pelanggan['id'] ?>" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="/Jobsheet9/pelanggan/proses_beli.php" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="id_barang_<?= $pelanggan['id'] ?>"
                                                            class="form-label fw-semibold">Pilih Barang yang
                                                            Tersedia</label>
                                                        ...
                                                        <select class="form-select" name="id_barang"
                                                            id="id_barang_<?= $pelanggan['id'] ?>" required>
                                                            <option value="" disabled selected>Pilih Barang</option>
                                                            <?php foreach ($daftarBarang as $b): ?>
                                                            <option value="<?= $b['id'] ?>">
                                                                <?= htmlspecialchars($b['nama']) ?> — Rp
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="jumlah_<?= $pelanggan['id'] ?>"
                                                            class="form-label fw-semibold">Jumlah Pembelian
                                                            (pcs)</label>
                                                        <input type="number" class="form-control" name="jumlah"
                                                            id="jumlah_<?= $pelanggan['id'] ?>" min="1" value="1"
