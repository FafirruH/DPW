        ...
        <div class="card-body p-4">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="/Jobsheet9/barang/tambah.php" class="btn btn-theme btn-sm">
                        + Tambah Barang
                    </a>
                </div>
            </div>
            ...
            <div class="search-box mb-3">
                ...
                <input type="text" class="form-control" id="search-input"
                    placeholder="Ketik nama barang atau merek..." />
            </div>
            ...
            <div class="table-responsive mt-3">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">Belum ada data barang. Silakan tambah
                                barang baru.</td>
                        </tr>
                        <?php else: ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <span
                                    class="badge bg-light text-dark border"><?= htmlspecialchars($barang['kategori'] ?? 'Umum') ?></span>
                            </td>
                            ...
                            <td class="text-center">
                                <a href="/Jobsheet9/barang/edit.php?id=<?= $barang['id'] ?>"
                                    class="btn btn-sm btn-outline-warning me-1">
                                    Edit
                                </a>
                                <a href="/Jobsheet9/barang/hapus.php?id=<?= $barang['id'] ?>"
